...
public class RenderElectricGolem <T extends ElectricGolem> extends MobRenderer<T, WitchGolemModel<T>> {

	private static final ResourceLocation TEX = SweetMagicCore.getSRC("textures/entity/electricgolem.png");

	public RenderElectricGolem(EntityRendererProvider.Context con) {
