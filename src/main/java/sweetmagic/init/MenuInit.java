...
import sweetmagic.init.tile.gui.GuiAlternativeTank;
import sweetmagic.init.tile.gui.GuiAquariumPot;
import sweetmagic.init.tile.gui.GuiCardboardStorage;
import sweetmagic.init.tile.gui.GuiClero;
import sweetmagic.init.tile.gui.GuiCompas;
import sweetmagic.init.tile.gui.GuiDresser;
...
import sweetmagic.init.tile.gui.GuiMFGenerater;
...
import sweetmagic.init.tile.gui.GuiPhone;
import sweetmagic.init.tile.gui.GuiPlate;
import sweetmagic.init.tile.gui.GuiPorch;
import sweetmagic.init.tile.gui.GuiRegister;
...
import sweetmagic.init.tile.gui.GuiTransferGateVertical;
...
public class MenuInit {
	...
	public static final MenuType<PhoneMenu> phoneMenu = register("phone_menu", PhoneMenu::new);
	...
	public static final MenuType<MFWoodCutterMenu> woodCutterMenu = register("woodcutter_menu", MFWoodCutterMenu::new);
	public static final MenuType<MagiaLanternMenu> magiaLanternMenu = register("magialantern_menu", MagiaLanternMenu::new);
	public static final MenuType<RegisterMenu> registerMenu = register("register_menu", RegisterMenu::new);
	public static final MenuType<NotePCMenu> notePcMenu = register("notepc_menu", NotePCMenu::new);
	...
	public static <M extends AbstractContainerMenu, U extends Screen & MenuAccess<M>> void registerGUI() {
		...
		MenuScreens.register(MenuInit.phoneMenu, GuiPhone::new);
		...
		MenuScreens.register(MenuInit.woodCutterMenu, GuiMFWoodCutter::new);
		MenuScreens.register(MenuInit.magiaLanternMenu, GuiMagiaLantern::new);
		MenuScreens.register(MenuInit.registerMenu, GuiRegister::new);
		MenuScreens.register(MenuInit.notePcMenu, GuiNotePC::new);
	}

	public static <T extends TileAbstractSM> T getTile(BlockEntityType.BlockEntitySupplier<T> tiType, Inventory inv, FriendlyByteBuf buf) {
		return (T) inv.player.getLevel().getBlockEntity(buf.readBlockPos());
	}
