...
public class GuiRegister extends GuiSMBase<RegisterMenu> {

	private static final ResourceLocation TEX = SweetMagicCore.getSRC("textures/gui/gui_magia_lantern.png");
	private final TileRegister tile;

	public GuiRegister(RegisterMenu menu, Inventory pInv, Component title) {
		...
		this.addRenderTexList(new SMRenderTex(TEX, 73, 28, 0, 200, 27, 13, new SMButtonTip("register_exp", 0, -4)));
	}
	...
	protected void renderBg(PoseStack pose, float parTick, int mouseX, int mouseY) {
		...
		this.font.drawShadow(pose, this.getLabel(this.tile.getExpLevel()), x + 75, y + 31, 0x2BC444);
