...
public class GuiMagicBarrier extends GuiSMBase<MagicBarrierMenu> {

	private static final ResourceLocation TEX = SweetMagicCore.getSRC("textures/gui/gui_smspawner.png");
	private final TileMagicBarrier tile;

	public GuiMagicBarrier(MagicBarrierMenu menu, Inventory pInv, Component title) {
		super(menu, pInv, title);
		this.tile = menu.tile;
		this.setGuiWidth(172);
		this.setGuiHeight(131);
