...
public class RenderSkullFlameArcher extends SkeletonRenderer {

	private static final ResourceLocation TEX = SweetMagicCore.getSRC("textures/entity/skullflame_archer.png");

	public RenderSkullFlameArcher(EntityRendererProvider.Context con) {
		super(con);
