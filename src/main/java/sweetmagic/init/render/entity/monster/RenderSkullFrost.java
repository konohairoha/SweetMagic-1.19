...
public class RenderSkullFrost extends SkeletonRenderer {

	private static final ResourceLocation TEX = SweetMagicCore.getSRC("textures/entity/skullflost.png");

	public RenderSkullFrost(EntityRendererProvider.Context con) {
		super(con);
	}
