...
public class RenderMFMinerAdvanced extends RenderAbstractTile<TileMFMinerAdvanced> {
	...
	@Override
	public void render(TileMFMinerAdvanced tile, float parTick, PoseStack pose, MultiBufferSource buf, int light, int overlayLight) {
	...
	public void renderItem(TileMFMinerAdvanced tile, float parTick, PoseStack pose, MultiBufferSource buf, int light, int overlayLight) {
	...
	public void renderSquare(TileMFMinerAdvanced tile, float parTick, PoseStack pose, MultiBufferSource buf, int light, int overlayLight) {
