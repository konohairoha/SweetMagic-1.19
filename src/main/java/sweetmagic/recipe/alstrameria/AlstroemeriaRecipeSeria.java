...
public class AlstroemeriaRecipeSeria extends AbstractRecipeSerializer implements RecipeSerializer<AlstroemeriaRecipe> {

	// jsonからレシピを生成する
	@Override
	public AlstroemeriaRecipe fromJson(ResourceLocation id, JsonObject json) {
		...
		return new AlstroemeriaRecipe(id, resultList, ingredList, countList);
	}

	// サーバー側から受け取ったパケットから、レシピを復元する
	@Override
	public @Nullable AlstroemeriaRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
	...
	@Override
	public void toNetwork(FriendlyByteBuf buffer, AlstroemeriaRecipe recipe) {
