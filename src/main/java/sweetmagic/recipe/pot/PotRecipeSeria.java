...
public class PotRecipeSeria extends AbstractRecipeSerializer implements RecipeSerializer<PotRecipe> {
	...
	public PotRecipe fromJson(ResourceLocation id, JsonObject json) {
		...
		return new PotRecipe(id, resultList, ingredList, countList);
	}

	// サーバー側から受け取ったパケットから、レシピを復元する
	@Override
	public @Nullable PotRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
