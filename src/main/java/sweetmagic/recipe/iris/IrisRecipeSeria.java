...
public class IrisRecipeSeria extends AbstractRecipeSerializer implements RecipeSerializer<IrisRecipe> {

	// jsonからレシピを生成する
	@Override
	public IrisRecipe fromJson(ResourceLocation id, JsonObject json) {
		...
		return new IrisRecipe(id, resultList, ingredList, countList);
	}

	// サーバー側から受け取ったパケットから、レシピを復元する
	@Override
	public @Nullable IrisRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
	...
	@Override
	public void toNetwork(FriendlyByteBuf buffer, IrisRecipe recipe) {
