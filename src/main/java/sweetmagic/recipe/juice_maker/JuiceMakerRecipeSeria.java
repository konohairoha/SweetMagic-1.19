...
public class JuiceMakerRecipeSeria extends AbstractRecipeSerializer implements RecipeSerializer<JuiceMakerRecipe> {
	...
	@Override
	public @Nullable JuiceMakerRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
	...
	@Override
	public void toNetwork(FriendlyByteBuf buffer, JuiceMakerRecipe recipe) {
