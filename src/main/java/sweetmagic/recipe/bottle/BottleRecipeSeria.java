...
public class BottleRecipeSeria extends AbstractRecipeSerializer implements RecipeSerializer<BottleRecipe> {

	// jsonからレシピを生成する
	@Override
	public BottleRecipe fromJson(ResourceLocation id, JsonObject json) {
		...
		return new BottleRecipe(id, resultList, ingredList, countList);
	}

	// サーバー側から受け取ったパケットから、レシピを復元する
	@Override
	public @Nullable BottleRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
	...
	@Override
	public void toNetwork(FriendlyByteBuf buf, BottleRecipe recipe) {
